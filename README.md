...
- Preview: https://main--storefront--ethonis-media.hlx.page/
- Live: https://main--storefront--ethonis-media.hlx.live/
...
1. Open the `storefront` directory in your favorite IDE and start coding :)
